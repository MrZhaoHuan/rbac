<%@ page import="com.zhao.pojo.User"  isELIgnored="false" %>
            ...
            <ul class="nav ace-nav">
                <li class="light-blue dropdown-modal">
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        <li>
                            <a href="javascript:void(0)"> <i class="ace-icon fa fa-cog"></i>
                                设置
                            </a>
                        </li>
                        <li>
...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                ...
                <ul class="submenu" id="permSubMene">
                    <%-- todo:查询用户的菜单权限，动态遍历生成 --%>
                </ul>
            </li>
    ...
    <div class="main-content">
        <iframe id="innerFrame" src="${pageContext.request.contextPath}/dept/listPage.page" width="99%" style="min-height: 768px;"></iframe>
    </div>
    <!-- /.main-content -->
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/menu/list.json", //todo: 菜单请求url让别人看到，不太好啊，最好是后台返回菜单数据，懒得改了，先这样吧
            success : function (result) {
                if (result.code==="0") {
                    var menuList = result.data;
                    var permSubMenuDom = $("#permSubMene");
                    var menuStr = "";
                    for(var index in menuList){
                        menuStr +=  '<li><a class="popstyle" href="'+menuList[index].url+'" target="_blank" >'
                        +'<i class="menu-icon fa fa-caret-right"></i>'
                        +menuList[index].name+'</a><b class="arrow"></b></li>';
                    }
                    permSubMenuDom.append(menuStr);
